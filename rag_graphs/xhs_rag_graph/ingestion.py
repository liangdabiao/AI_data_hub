...
class DocumentSyncManager:
    def __init__(self):
        ...
        self.xhs_collection = self.mongo_client.get_collection(collection_name=os.getenv('XHS_COLLECTION_NAME'))
